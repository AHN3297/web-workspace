...
<body>
	<h1> 안녕 나는 웰컴 파일이라고해 </h1>
	<h2> * EL(Expression Language)</h2>
	<p>
		JSP상에서는 출력하고 싶으면 충역식 써야함 => &lt;%= 변수 %> <br>
		EL구문을 사용하면 \${ 변수 } 형식으로 작성할 수 있다.
	</p>
	...
	1. Scriping Element : JSP상에서 자바코드를 직접 기술할 수 있게해주는 요소
	2. 문자열 : HTML, CSS, J.S
	3. 지시어 : JSP 페이지 정보를 기술한다거나 (page) 포함시킬 때 사용 (include)
